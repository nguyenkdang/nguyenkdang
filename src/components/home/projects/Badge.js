...
const Badge = () => {
    return (
        <div className="middle-badge">
            <svg id="project_badge" data-name="project badge" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 234.37 379.23" width="20vw">
            <defs>
                <style>
                {'.cls-1 { fill: #fff; }'}
